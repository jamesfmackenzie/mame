...
echo "Role mapping:"
echo "  LEFT   = local 15111 -> remote 15112"
echo "  CENTER = local 15112 -> remote 15113"
echo "  RIGHT  = local 15113 -> remote 15111"
echo
echo "Each instance's window title is tagged with its role (LEFT / CENTER / RIGHT)."
echo "There is no in-game DIP switch for cabinet role in this branch."
echo
echo "Logs:"
...
echo "Startup wait:"
echo "  waiting for C139 RX listen log messages from this tree"
echo

echo "Launching LEFT (local 15111 -> remote 15112)..."
...
PID1=$!
echo "  PID $PID1"
wait_for_log "$ROOT_DIR/rrf_left.log" "C139: RX listen on" "LEFT listener"

echo "Launching CENTER (local 15112 -> remote 15113)..."
...
PID2=$!
echo "  PID $PID2"
wait_for_log "$ROOT_DIR/rrf_center.log" "C139: RX listen on" "CENTER listener"

echo "Launching RIGHT (local 15113 -> remote 15111)..."
...
PID3=$!
echo "  PID $PID3"
wait_for_log "$ROOT_DIR/rrf_right.log" "C139: RX listen on" "RIGHT listener"
echo
echo "Tail logs with:"
